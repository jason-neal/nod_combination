...
__title__ = "nod_combination"
__summary__ = "Combine optimal-nonoptimal nod-cycle extracted spectra with sigma clipping."
...
__copyright__ = "2017 {0!s}".format(__author__)
